        ...
        <div>
            <div style={{display: "flex"}}>
                <div style={{marginRight: 40, width: "40%"}}>
                    ...
                    <div style={{width: '60%'}}>
                        <ButtonArt text="Перейти к выставке" size="normal" variant="arrow"
                                   onClick={() => console.log('Clicked')}/>
                        <ButtonArt text="Узнать больше" size="normal" variant="text"
                                   onClick={() => console.log('Clicked')}/>
                        <ButtonArt size="normal" variant="icon" icon={icon2} onClick={() => console.log('Clicked')}/>
                        <ButtonArt size="normal" variant="icon" icon={icon1} onClick={() => console.log('Clicked')}/>
                        <ButtonArt size="small" variant="textAndIcon" text="Поиск" icon={icon1}
                                   onClick={() => console.log('Clicked')}/>
                    </div>
